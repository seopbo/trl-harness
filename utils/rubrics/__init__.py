# Copy from https://github.com/allenai/open-instruct/blob/main/open_instruct/rubrics/__init__.py
"""
...
from .prompts import INSTANCE_WISE_RUBRIC_GENERATION_PROMPT, RUBRIC_SCORING_PROMPT
